...
Se verificaron valores nulos en los campos de IdCliente, georeferencia y cantidad. 

Comenzamos por eliminar las lineas con IdCliente nulo (consideramos que no es representativo y puede afectar el analisis)
...
Antes de continuar con el tratamiento de las variables de georeferencia, consideramos necesesario saber que porcentaje de ventas representan las lineas sin el dato de latitud y longitud:
...
-  Productos PRE: Localidad mas cercana Chilibroste, Córdoba.
-  Productos CON: Localidad mas cercana Arias, Córdoba. 
-  Productos SIL: Localidad mas cercana Oliva, Córdoba.
